...
<OpenRocketComponent>
    ...
    <Materials>
      ...
      <!-- Materials matching values in generic_materials.orc -->
        ...
        <Material UnitsOfMeasure="g/m2">
            <Name>[material:1.1 oz. Ripstop Nylon]</Name>
            <Density>0.03735</Density>
            <Type>SURFACE</Type>
        </Material>

        <!-- 1.7oz is Top Flight standard material -->
        <Material UnitsOfMeasure="g/m2">
    ...
    <Components>
        ...
        <Parachute>
            ...
            <Material Type="SURFACE">[material:1.7 oz. Ripstop Nylon]</Material>
        ...
        <Parachute>
            ...
            <Material Type="SURFACE">[material:1.1 oz. Ripstop Nylon]</Material>
            <Diameter Unit="in">9.0</Diameter>
            <Sides>6</Sides>
            <LineCount>6</LineCount>
            <LineLength Unit="in">9.0</LineLength>
